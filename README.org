    ...
    1. A src/main/feature/feature.xml template file, referencing the authservice feature repository and the authservice feature, e.g.:
       #+BEGIN_SRC nxml
         ...
         <features xmlns="http://karaf.apache.org/xmlns/features/v1.5.0" name="authservice.bundle">
             <repository>mvn:no.priv.bang.authservice/karaf/1.14.0/xml/features</repository>
...
|------------------+---------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [2022-05-29 Sun] |  1.14.0 | Use karaf 4.4.0 and OSGi 8                                                                                                                                                       |
| [2022-02-21 Mon] | 1.13.12 | Use Java 11, karaf 4.3.6, postgresql JDBC 42.3.3, jersey 2.35, jackson 2.13.1 and node.js 16.14.0                                                                                |
| [2021-10-13 Wed] | 1.13.11 | karaf 4.3.3, postgresql JDBC 4.2.24, junit jupiter 5.8.1, mockito 4.0.0 and assertj 3.21.0                                                                                       |
| [2021-09-30 Thu] | 1.13.10 | Use jsoup 1.14.3 and axios 0.21.4                                                                                                                                                |
