    ...
    1. A src/main/feature/feature.xml template file, referencing the authservice feature repository and the authservice feature, e.g.:
       #+BEGIN_SRC nxml
         ...
         <features xmlns="http://karaf.apache.org/xmlns/features/v1.5.0" name="authservice.bundle">
             <repository>mvn:no.priv.bang.authservice/karaf/1.15.20/xml/features</repository>
...
|------------------+---------+-------------------------------------------------------------------------------------------------------------------------------------------------------|
| [2024-04-06 Sat] | 1.15.20 | Use liquibase 4.27.0, build with node.js 20.12.0 and karaf 4.4.5                                                                                      |
| [2024-03-25 Mon] | 1.15.19 | Use postgresql jdbc 42.7.3, jersey 2.42, jackson 2.16.2                                                                                               |
