...
insert into users (username,password,password_salt,email,firstname,lastname) values ('jad','adEp0s7cQHrJcIsDTDoFQK8eUAIFGh23wew7Klis1sk=', '78dCvMDECA47YMdtCkgkwQ==','janedoe7896@gmail.com','Janet','Doe');
