...
public class AuthserviceIntegrationTest {
    ...
    public Option[] config() {
        ...
        final MavenArtifactUrlReference authserviceFeatureRepo = maven().groupId("no.priv.bang.authservice").artifactId("authservice.bundle").versionAsInProject().type("xml").classifier("features");
        return options(
